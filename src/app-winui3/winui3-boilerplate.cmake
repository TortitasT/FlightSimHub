# Adapted from FreeOpenKneeboard's winui3-boilerplate.cmake
...
target_link_windows_app_sdk(FSHub-App)

set_target_properties(
  FSHub-App
  PROPERTIES
  VS_GLOBAL_RootNamespace FlightSimHubApp
...
# Set source file dependencies properly for Xaml and non-Xaml IDL files.
# Without this, module.g.cpp will not include the necessary headers for
# non-Xaml IDL files.
get_target_property(SOURCES FSHub-App SOURCES)
...
target_sources(FSHub-App PRIVATE "${MODULE_G_CPP}")
set_property(
  SOURCE "${MODULE_G_CPP}"
